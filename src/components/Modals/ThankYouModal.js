...
export const ThankYouModal = ({ style }) => {
    ...
    <div style={{...style}} className="modal">
      <div className="modal__wrapper">
        <div className="modal__content modal__content--center">
          <img width="90px" height="90px" src="/images/svg/Check.svg" alt="" />
          <p>
            Мы отправили на указаный e-mail 
            ссылку с восстановлением
          </p>
          <button onClick={handlerCloseModal} className='btn'>На главную</button>
